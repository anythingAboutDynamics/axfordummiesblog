...
<?php if ( function_exists( 'language_attributes' ) ) language_attributes(); ?>>
<head>
...
<body>
	<h1 id="logo">
		<img alt="WordPress"
			src="<?php echo esc_attr( admin_url( 'images/wordpress-logo.png' ) ); ?>" />
	</h1>
	<form
		...
		<p>
			<?php echo esc_html( stripslashes( $_GET['msg'] ) ); ?>
		</p>
