		...
		<table class="form-table">
			...
			<tr class="form-field form-required">
				...
				<td><input name="blog[path]" type="text" id="path"
					...
					<?php if ( get_blog_option( $id, 'siteurl' ) == untrailingslashit( get_blogaddress_by_id ($id ) ) || get_blog_option( $id, 'home' ) == untrailingslashit( get_blogaddress_by_id( $id ) ) ) echo 'checked="checked"'; ?> />
