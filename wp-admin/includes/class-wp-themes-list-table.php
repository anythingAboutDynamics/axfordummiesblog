...
<div class="tablenav themes <?php echo $which; ?>">
	...
	<img
		...
		class="ajax-loading list-ajax-loading" alt="" /> <br class="clear" />
</div>
<?php
	}
...
<div class="<?php echo join( ' ', $class ); ?>">
	...
	<a href="<?php echo $preview_link; ?>"
		class="<?php echo $thickbox_class; ?> screenshot"> <?php if ( $screenshot ) : ?>
		<img
	...
	<?php } else { ?>
	<p>
		<?php printf( __( 'All of this theme&#8217;s files are located in <code>%2$s</code>.' ), $title, str_replace( WP_CONTENT_DIR, '', $template_dir ), str_replace( WP_CONTENT_DIR, '', $stylesheet_dir ) ); ?>
	</p>
	<?php } ?>
	<?php if ( $tags ) : ?>
	<p>
