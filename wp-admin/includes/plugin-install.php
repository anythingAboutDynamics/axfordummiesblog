...
function install_dashboard() {
	?>
<p>
	<?php printf( __( 'Plugins extend and expand the functionality of WordPress. You may automatically install plugins from the <a href="http://wordpress.org/extend/plugins/">WordPress Plugin Directory</a> or upload a plugin in .zip format via <a href="%s">this page</a>.' ), self_admin_url( 'plugin-install.php?tab=upload' ) ); ?>
</p>
...
<p class="install-help">
	<?php _e('Search for plugins by keyword, author, or tag.') ?>
</p>
...
<form id="search-plugins" method="get" action="">
	...
	</select> <input type="text" name="s"
		value="<?php echo esc_attr($term) ?>" /> <label
		class="screen-reader-text" for="plugin-search-input"><?php _e('Search Plugins'); ?>
	</label>
...
<form method="post" enctype="multipart/form-data"
	...
	</label> <input type="file" id="pluginzip" name="pluginzip" /> <input
...
<div class="alignright fyi">
	...
	<ul>
		...
		<li><a target="_blank"
			href="http://wordpress.org/extend/plugins/<?php echo $api->slug ?>/"><?php _e('WordPress.org Plugin Page &#187;') ?>
		</a></li>
