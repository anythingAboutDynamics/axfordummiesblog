				...
				<td colspan="<?php echo $this->get_column_count(); ?>"
					...
					<fieldset>
						<div class="inline-edit-col">
							...
							<label> <span class="title"><?php _ex( 'Name', 'term name' ); ?>
									...
									name="name" class="ptitle" value="" /> </span>
							</label>
					...
					<p class="inline-edit-save submit">
						...
						<a accesskey="s" href="#inline-edit"
							title="<?php echo esc_attr( $update_text ); ?>"
							...
							alt="" /> <span class="error" style="display: none;"></span>
						<?php wp_nonce_field( 'taxinlineeditnonce', '_inline_edit', false ); ?>
						<input type="hidden" name="taxonomy"
							value="<?php echo esc_attr( $tax->name ); ?>" /> <input
							type="hidden" name="post_type"
							value="<?php echo esc_attr( $post_type ); ?>" /> <br
							class="clear" />
					</p>
				</td>
			</tr>
