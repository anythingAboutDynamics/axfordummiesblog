...
<div
	class="wrap columns-<?php echo (int) $screen_layout_columns ? (int) $screen_layout_columns : 'auto'; ?>">
	<?php screen_icon(); ?>
	<h2>
...
wp_nonce_field( 'meta-box-order', 'meta-box-order-nonce', false ); ?>
	...
	<div id="poststuff"
		class="metabox-holder<?php echo 1 != $screen_layout_columns ? ' has-right-sidebar' : ''; ?>">
		...
		<div id="post-body">
			<div id="post-body-content">
				<div id="namediv" class="stuffbox">
					...
					<div class="inside">
						<input type="text" name="link_name" size="30" tabindex="1"
				...
				<div id="addressdiv" class="stuffbox">
					...
					<div class="inside">
						<input type="text" name="link_url" size="30" class="code"
							tabindex="1" value="<?php echo esc_attr($link->link_url); ?>"
							id="link_url" />
						<p>
				...
				<div id="descriptiondiv" class="stuffbox">
					...
					<div class="inside">
						<input type="text" name="link_description" size="30" tabindex="1"
...
if ( $link_id ) : ?>
				...
				<input type="hidden" name="order_by"
					value="<?php echo esc_attr($order_by); ?>" /> <input type="hidden"
					name="cat_id" value="<?php echo (int) $cat_id ?>" />
				<?php else: ?>
