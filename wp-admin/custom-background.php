				...
				?>
					<div id="custom-background-image" style="<?php echo $background_styles; ?>">
						...
						<img class="custom-background-image"
							src="<?php echo get_theme_mod('background_image_thumb', ''); ?>"
				...
				<tr valign="top">
					...
					<td><fieldset>
							...
							<label> <input name="background-position-x" type="radio"
								...
								<?php _e('Left') ?>
							</label> <label> <input name="background-position-x" type="radio"
								value="center"
				...
				<tr valign="top">
					...
					<td><fieldset>
							...
							<label> <input name="background-attachment" type="radio"
								...
								<?php _e('Scroll') ?>
							</label> <label> <input name="background-attachment" type="radio"
								value="fixed"
				...
				<tr valign="top">
					...
					<td><fieldset>
							...
							<input type="text" name="background-color" id="background-color"
								value="#<?php echo esc_attr(get_background_color()) ?>" /> <a
								class="hide-if-no-js" href="#" id="pickcolor"><?php _e('Select a Color'); ?>
							</a> <span <?php echo $show_clear; ?> class="hide-if-no-js"
								id="clearcolor"> (<a href="#"><?php _e( 'Clear' ); ?> </a>)
							</span>
