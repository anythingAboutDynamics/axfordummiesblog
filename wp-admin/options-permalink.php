...
<div class="wrap">
	...
	<form name="form" action="options-permalink.php" method="post">
		...
		<table class="form-table">
			<tr>
				<th><label><input name="selection" type="radio" value="" class="tog"
			...
			<tr>
				<th><label><input name="selection" type="radio"
						value="<?php echo esc_attr($structures[1]); ?>" class="tog"
			...
			<tr>
				<th><label><input name="selection" type="radio"
						value="<?php echo esc_attr($structures[2]); ?>" class="tog"
			...
			<tr>
				<th><label><input name="selection" type="radio"
						value="<?php echo esc_attr($structures[3]); ?>" class="tog"
			...
			<tr>
				<th><label><input name="selection" type="radio"
						value="<?php echo esc_attr($structures[4]); ?>" class="tog"
			...
			<tr>
				...
				<td><?php echo $blog_prefix; ?> <input name="permalink_structure"
					id="permalink_structure" type="text"
