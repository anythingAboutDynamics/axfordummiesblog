...
<body>
	<h1 id="logo">
		<img alt="WordPress" src="images/wordpress-logo.png" />
	</h1>
	<?php
...
switch($step) {
	...
	<p>Welcome to WordPress. Before getting started, we need some
		information on the database. You will need to know the following items
		before proceeding.</p>
	<ol>
		<li>Database name</li>
	...
	<p>
		<strong>If for any reason this automatic file creation doesn't work,
			...
			configuration file. You may also simply open <code>wp-config-sample.php</code>
			in a text editor, fill in your information, and save it as <code>wp-config.php</code>.
		</strong>
	</p>
	<p>In all likelihood, these items were supplied to you by your Web
		...
		contact them before you can continue. If you&#8217;re all
		ready&hellip;</p>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><input name="dbhost" id="dbhost" type="text" size="25"
					value="localhost" /></td>
				<td>You should be able to get this info from your web host, if <code>localhost</code>
					does not work.
				</td>
			</tr>
			<tr>
				...
				<td><input name="prefix" id="prefix" type="text" value="wp_"
					size="25" /></td>
				<td>If you want to run multiple WordPress installations in a single
					database, change this.</td>
			</tr>
		</table>
...
case 2:
	...
	*/
	...
	<p class="step">
		<a href="install.php" class="button">Run the install</a>
	</p>
	<?php
	else :
	...
	<p>All right sparky! You've made it through this part of the
		...
		are ready, time now to&hellip;</p>
