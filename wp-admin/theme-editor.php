...
<div class="wrap">
	...
	<div class="fileedit-sub">
		<div class="alignleft">
			<h3>
				<?php echo $themes[$theme]['Name'] . ': ' . $desc_header; ?>
			</h3>
		</div>
	...
	<div id="templateside">
		...
		<p class="howto">
			<?php printf( __( 'This child theme inherits templates from a parent theme, %s.' ), $themes[$theme]['Parent Theme'] ); ?>
		</p>
		<?php endif; ?>
		<ul>
			<?php
			...
			?>
			<li><a
				href="theme-editor.php?file=<?php echo urlencode( $template_file ) ?>&amp;theme=<?php echo urlencode( $theme ) ?>&amp;dir=theme"><?php echo $filedesc ?>
			</a></li>
			<?php endwhile; ?>
		</ul>
		<h3>
			<?php /* translators: Theme stylesheets in theme editor */ _ex('Styles', 'Theme stylesheets in theme editor'); ?>
		</h3>
		<ul>
			<?php
			$template_mapping = array();
			...
			?>
			<li><a
				href="theme-editor.php?file=<?php echo urlencode( $style_file ) ?>&amp;theme=<?php echo urlencode($theme) ?>&amp;dir=style"><?php echo $filedesc ?>
			</a></li>
			<?php endwhile; ?>
		</ul>
		<?php endif; ?>
	...
	<form name="template" id="template" action="theme-editor.php"
		...
		<div>
			...
			<input type="hidden" name="action" value="update" /> <input
				...
				type="hidden" name="theme" value="<?php echo esc_attr($theme) ?>" />
