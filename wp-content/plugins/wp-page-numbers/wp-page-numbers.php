...
<form method="post" name="options" target="_self">
		...
		<table style="width: 100%;" border="0">
			...
			<tr>
				...
				<td style="padding-top: 5px; padding-bottom: 5px;"><input
					...
					?> /> <img
					src="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/wp-page-numbers/default/preview.gif"
					alt="" />
				</td>
			</tr>
			<tr>
				...
				<td style="padding-top: 5px; padding-bottom: 5px;"><input
					type="radio" name="style_theme" value="classic"
					<?php
					...
					?> /> <img
					src="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/wp-page-numbers/classic/preview.gif"
					alt="" />
				</td>
			</tr>
			<tr>
				...
				<td style="padding-top: 5px; padding-bottom: 5px;"><input
					type="radio" name="style_theme" value="tiny"
					<?php
					...
					?> /> <img
					src="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/wp-page-numbers/tiny/preview.gif"
					alt="" />
				</td>
			</tr>
			<tr>
				...
				<td style="padding-top: 5px; padding-bottom: 5px;"><input
					type="radio" name="style_theme" value="panther"
					<?php
					...
					?> /> <img
					src="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/wp-page-numbers/panther/preview.gif"
					alt="" />
				</td>
			</tr>
			<tr>
				...
				<td style="padding-top: 5px; padding-bottom: 5px;"><input
					type="radio" name="style_theme" value="stylish"
					<?php
					...
					?> /> <img
					src="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/wp-page-numbers/stylish/preview.gif"
					alt="" />
				</td>
			</tr>
			<tr>
				<td><strong>Theme folder name: </strong><span style="color: red;">OVERRIDE</span>
					settings above</td>
				<td colspan="3"><input name="head_stylesheetsheet_folder_name"
					type="text" style="width: 100%;"
					value="<?php echo $head_stylesheet_folder_name; ?>" />
				</td>
			</tr>

			<tr>
				<td></td>
				<td colspan="2">- Have you create a cool WP Page Numbers theme?<br />
					- Want to share it to the rest of the world? <a
					href="http://www.jenst.se/2008/03/29/wp-page-numbers/">Write a
						comment about it</a>.
				</td>
			</tr>
		</table>
	...
	<div class="wrap">
		...
		<table style="width: 100%;" border="0">
			...
			<tr>
				...
				<td colspan="3"><input name="page_of_page_text" type="text"
					style="width: 100%;" value="<?php echo $page_of_page_text; ?>" />
				</td>
			</tr>

			<tr>
				<td><strong>Default text: </strong>of</td>
				<td colspan="3"><input name="page_of_of" type="text"
					style="width: 100%;" value="<?php echo $page_of_of; ?>" />
				</td>
			</tr>

			<tr>
				<td><strong>Default text: </strong>&lt;</td>
				<td colspan="3"><input name="prevpage" type="text"
					style="width: 100%;" value="<?php echo $prevpage; ?>" />
				</td>
			</tr>

			<tr>
				<td><strong>Default text: </strong>...</td>
				<td colspan="3"><input name="startspace" type="text"
					style="width: 100%;" value="<?php echo $startspace; ?>" />
				</td>
			</tr>

			<tr>
				<td><strong>Default text: </strong>...</td>
				<td colspan="3"><input name="endspace" type="text"
					style="width: 100%;" value="<?php echo $endspace; ?>" />
				</td>
			</tr>

			<tr>
				<td><strong>Default text: </strong>&gt;</td>
				<td colspan="3"><input name="nextpage" type="text"
					style="width: 100%;" value="<?php echo $nextpage; ?>" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="wrap">
		...
		<table style="width: 100%;" border="0">
			...
			<tr>
				...
				<td><input type="checkbox" name="page_of_page"
				<?php
			...
			<tr>
				<td><strong>Show next / previous page text 
				
				</td>
				<td><input type="checkbox" name="next_prev_text"
				<?php
			...
			<tr>
				<td><strong>Show start and end numbers 
				
				</td>
				<td><input type="checkbox" name="show_start_end_numbers"
				<?php
			...
			<tr>
				<td><strong>Show page numbers 
				
				</td>
				<td><input type="checkbox" name="show_page_numbers"
				<?php
	...
	<div class="wrap">
		...
		<table style="width: 100%;" border="0">
			<tr>
				<td style="width: 400px;"><strong>Number of pages to show: </strong>10
					(0 = unlimited)</td>
				<td colspan="3"><input name="limit_pages" type="text"
					style="width: 100%;" value="<?php echo $limit_pages; ?>" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="wrap">
		...
		<p>
			Add the code where you find
			<code>previous_post()</code>
			and
			<code>next_post()</code>
			functions. If you can't find these tags, place the code between
			<code>endwhile;</code>
			and
			<code>endif;</code>
			in the_loop.
		...
		<table>
			...
			<tr>
				<td style="width: 400px;"><strong>Syntax:</strong> <code>wp_page_numbers($start,
						$end);</code></td>
				<td><strong>Example:</strong> <code>wp_page_numbers("&lt;div
						class='start'&gt;", "&lt;/div&gt;");</code></td>
			</tr>
		</table>
	</div>
	...
	<div class="wrap">
		...
		<table>
			...
			<tr>
				<td>You can set all the texts to what ever you like, except the
					numbers. They will still be numbers.<br /> <br />
				</td>
			</tr>
			...
			<tr>
				<td>This will limit your paging menu. Set a of maximum amount of
					pages to be displayed at the same time. If the textfield is blank,
					10 is set by default. If 0 is set, it will not limit the paging.<br />
					<br />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<ol>
						...
						<li>Edit the '<strong>wp-page-numbers.css</strong>' to make your
							changes
						</li>
						<li>Rename your folder copy to a theme name</li>
						<li>Upload your folder into '<strong>wp-content/plugins/wp-page-numbers/</strong>'
						</li>
						<li>Set your '<strong>Theme folder name</strong>' in admin '<strong>Settings
								/ WP Page Numbers</strong>'
						</li>
						<li>'<strong>Update settings</strong>'. Done!
						</li>
					</ol>
				</td>
			</tr>
		...
		<p class="submit">
			<input name="submitted" type="hidden" value="yes" /> <input
				type="submit" name="Submit" value="Update Settings &raquo;" />
		</p>
