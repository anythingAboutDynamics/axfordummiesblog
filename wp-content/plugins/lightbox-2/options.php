...
<div class="wrap">
	<h2>
		<?php _e('Lightbox 2 Options', 'lightbox_2') ?>
	</h2>
	<form name="form1" method="post"
		action="<?php echo $location ?>&amp;updated=true">
		...
		<table width="100%" cellspacing="2" cellpadding="5" class="form-table">
			<tr valign="baseline">
				...
				?>
					<p>
						<small><?php _e('If in doubt, try the Black theme', 'lightbox_2') ?>
						</small>
					</p>
				</td>
			</tr>
			<tr valign="baseline">
				<th scope="row"><?php _e('Auto-lightbox image links', 'lightbox_2') ?>
				</th>
				<td><?php
				...
				?>
					<p>
						<small><?php _e('Let the plugin add necessary html to image links', 'lightbox_2') ?>
						</small>
					</p>
				</td>
			...
			<tr valign="baseline">
				<th scope="row"><?php _e('Shrink large images to fit smaller screens', 'lightbox_2') ?>
				</th>
				<td><?php
				...
				?>
					<p>
						<small><?php _e('Note: <u>Excessively large images</u> waste bandwidth and slow browsing!', 'lightbox_2') ?>
						</small>
					</p>
				</td>
			</tr>
		...
		<p class="submit">
			<input type="submit" name="Submit"
				value="<?php _e('Save Changes', 'lightbox_2') ?>" />
		</p>
	</form>
</div>
